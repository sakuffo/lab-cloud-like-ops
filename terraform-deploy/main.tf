...
resource "vsphere_virtual_machine" "ubuntu_nginx" {
  ...
  wait_for_guest_net_timeout  = 10    # Wait up to 10 minutes for network
  wait_for_guest_ip_timeout   = 10    # Wait up to 10 minutes for IP
  ...
  # Install nginx after VM is ready
